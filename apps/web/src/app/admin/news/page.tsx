...
export default function NewsDashboard() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      window.location.href = `/admin/news/${data.slug}`;
    },
  });
    ...
    <div className="min-h-screen bg-[#050505] text-white p-8 pt-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tighter">News Posts</h1>
            <p className="text-gray-400 mt-1">
              Manage newsroom articles, schedule releases, and track performance.
            </p>
          </div>
          <button
