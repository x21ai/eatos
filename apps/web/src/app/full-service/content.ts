...
export const marquee = [
  ...
  },
  {
    value: 'Always on',
    label:
      'Service keeps moving online or offline, with no lost checks. Checks and totals sync automatically the moment connectivity returns.',
  },
  {
    value: 'Support 24/7',
    label:
...
export const bundle = {
  ...
  specs: [
    ...
    },
    {
      ...
      body: 'Handhelds for coursing, order taking and split tender without a trip back to the station.',
    },
    {
