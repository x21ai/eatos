...
import { capabilities, ecosystem, hero, marquee, pillars } from './content';
...
const pillarIcons = {
  platform: { Icon: LayoutGrid, iconClass: 'bg-fuchsia-500/15 text-fuchsia-400' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="min-w-0 lg:col-span-6">
              ...
              <motion.p
                ...
                className="text-lg sm:text-xl md:text-2xl font-medium mb-6 text-fuchsia-400"
              >
                {hero.eyebrow}
              </motion.p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {ecosystem.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-fuchsia-500/15 text-fuchsia-400 flex items-center justify-center mb-6">
                    <Icon size={28} />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold tracking-tighter mb-3">
                    {item.title}
                  </h3>
                  <p className="text-white/90 leading-relaxed">{item.body}</p>
                </motion.div>
              );
            })}
          </div>
