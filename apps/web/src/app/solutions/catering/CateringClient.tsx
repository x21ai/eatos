...
const related = [
  ...
  },
  {
    ...
    tagline: 'Staff every event with the right people and hours.',
    Icon: Users,
...
const pillarIcons = {
  operations: { Icon: UtensilsCrossed, iconClass: 'bg-rose-500/15 text-rose-400' },
  inventory: { Icon: Package, iconClass: 'bg-amber-500/15 text-amber-400' },
  clients: { Icon: BarChart3, iconClass: 'bg-emerald-500/15 text-emerald-400' },
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="min-w-0 lg:col-span-6">
              ...
              <motion.p
                ...
                className="text-lg sm:text-xl md:text-2xl font-medium mb-6 text-rose-400"
              >
                {hero.eyebrow}
              </motion.p>
        ...
        <div className="site-container space-y-16 md:space-y-24">
          {pillars.map((pillar, index) => {
            const { Icon, iconClass } =
              pillarIcons[pillar.id] ?? { Icon: PartyPopper, iconClass: 'bg-white/10 text-white' };
            return (
              <motion.div
                key={pillar.id}
                id={pillar.id}
            ...
            {[
              {
                ...
                title: 'Big orders, no chaos',
                body: 'Event orders sit beside regular service, so one team runs both without a second system.',
                iconClass: 'bg-rose-500/15 text-rose-400',
              },
              {
                Icon: ShieldCheck,
                title: 'Reliable off site',
                body: 'Online or offline, orders and payments keep clearing wherever the event takes you.',
                iconClass: 'bg-amber-500/15 text-amber-400',
              },
              {
                Icon: Clock,
                title: '24/7 support',
                body: 'Real people, real help, any time. Weekends and late events included.',
