...
import opsImg from './assets/cat-ops.jpg.asset.json';
import inventoryImg from './assets/cat-inventory.jpg.asset.json';
import guestsImg from './assets/cat-guests.jpg.asset.json';
