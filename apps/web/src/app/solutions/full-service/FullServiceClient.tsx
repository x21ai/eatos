...
const related = [
  ...
  },
  {
    ...
    tagline: 'Courses timed and routed to the right station, so every dish hits the pass when it should.',
    Icon: ChefHat,
  ...
  },
  {
    ...
    tagline: 'Scheduling, clock-ins, and labor costs live in one place, so your team and budget stay in sync.',
    Icon: Users,
