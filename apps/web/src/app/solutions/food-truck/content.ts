...
import speedImg from './assets/truck-speed.jpg.asset.json';
import costsImg from './assets/truck-costs.jpg.asset.json';
import loyaltyImg from './assets/truck-loyalty.jpg.asset.json';
