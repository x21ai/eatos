        ...
        <Reveal delay={0.1} className="mt-14 hidden md:block">
          <div className="-mx-4 overflow-x-auto px-4 md:mx-0 md:px-6 lg:px-10">
            <table className="w-full min-w-[760px] border-separate border-spacing-0 text-left">
              <thead>
                <tr>
                  <th className="sticky left-0 z-10 bg-black pb-6 pr-2 align-bottom text-base font-semibold tracking-tight sm:text-lg">
                    Feature Set
                  </th>
              ...
              <tbody>
                {matrix.map((row, r) => (
                  <tr key={row.feature}>
                    <td className="sticky left-0 z-10 border-t border-white/8 bg-black py-5 pr-2 text-sm leading-6 text-zinc-300">
                      {row.feature}
                    </td>
                    <td
                      className={`border-t border-white/8 bg-white/[0.07] px-2 py-5 text-center ${
