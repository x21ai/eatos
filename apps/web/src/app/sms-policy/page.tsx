// @ts-nocheck
import { effectiveDate, intro, sections } from "./content";

export default function SmsPolicyPage() {
  const cardClass = "rounded-3xl border border-white/15 bg-white/5 p-7 md:p-9";
      ...
      <section className="pt-[128px] md:pt-[176px] pb-12 md:pb-16 bg-black border-b border-white/15">
        <div className="site-container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">{intro}</p>
