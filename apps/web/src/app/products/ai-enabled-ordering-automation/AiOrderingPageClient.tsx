...
const featureIcons = [
  { Icon: Mic, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: MessageSquare, tint: 'bg-indigo-500/10 text-indigo-400' },
  { Icon: Gauge, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: SlidersHorizontal, tint: 'bg-indigo-500/10 text-indigo-400' },
];

const hardwareIcons = [
  { Icon: LinkIcon, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: BarChart3, tint: 'bg-indigo-500/10 text-indigo-400' },
  { Icon: Headphones, tint: 'bg-purple-500/10 text-purple-400' },
];

const related = products.filter((p) => p.slug !== 'ai-enabled-ordering-automation').slice(0, 3);
...
export default function AiOrderingPageClient() {
  return (
    <div className="min-h-screen bg-black text-white font-montserrat selection:bg-purple-500/30">
      {/* Hero */}
      <section className="relative pt-[128px] md:pt-[176px] pb-16 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-500/20 via-indigo-600/10 to-transparent pointer-events-none" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-purple-500/10 rounded-full blur-[150px] pointer-events-none opacity-50" />
        ...
        <div className="site-container relative z-10">
          ...
          >
            ...
            <span className="text-white">AI-Enabled Ordering</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="min-w-0">
              <motion.div
                ...
                className="w-16 h-16 md:w-20 md:h-20 rounded-3xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mb-8 text-purple-400"
              >
                <Mic size={36} />
              </motion.div>
              ...
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-xs font-semibold uppercase tracking-[0.24em] text-purple-400 mb-4"
              >
                {hero.eyebrow}
              </motion.p>
              ...
              >
                {hero.title} <span className="text-purple-400">{hero.titleAccent}</span>
              </motion.h1>
            ...
            {[
              {
                ...
                body: 'Every ringing phone is answered on the first ring, even mid rush, so no order walks away.',
              },
              {
                Icon: Shield,
                tint: 'bg-indigo-500/10 text-indigo-400',
                title: 'Accurate every time',
                body: 'Voice recognition confirms items, modifiers and totals before the kitchen ticket is sent.',
              },
              {
                Icon: Clock,
      ...
      <section className="pb-20 md:pb-28">
        <div className="site-container">
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-indigo-600/10 to-transparent" />
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                Hear VoiceOS take a live order. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
