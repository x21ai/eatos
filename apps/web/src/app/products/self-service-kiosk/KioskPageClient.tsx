      ...
      <section className="pb-16 md:pb-20 border-t border-white/5 pt-16 md:pt-20">
        <div className="site-container">
          ...
          <motion.div
            ...
            className="mx-auto min-w-0 max-w-[300px] sm:max-w-[380px] rounded-[1.5rem] md:rounded-[2rem] border border-white/10 bg-zinc-900 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden"
          >
            <LazyVideo
