      ...
      <section className="pb-16 md:pb-20 border-t border-white/5 pt-16 md:pt-20">
        <div className="site-container">
          ...
          <motion.div
            ...
            className="mx-auto min-w-0 w-fit max-w-[260px] sm:max-w-[300px] lg:max-w-[340px] rounded-lg border border-white/10 bg-zinc-900 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden"
          >
            <LazyVideo
          ...
          >
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See the Self-Service Kiosk in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
