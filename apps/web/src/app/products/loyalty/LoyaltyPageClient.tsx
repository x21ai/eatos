...
const featureIcons = [
  { Icon: Smile, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: Share2, tint: 'bg-pink-500/10 text-pink-400' },
  { Icon: Gift, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: Repeat, tint: 'bg-pink-500/10 text-pink-400' },
];

const hardwareIcons = [
  { Icon: Smartphone, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: Mail, tint: 'bg-pink-500/10 text-pink-400' },
  { Icon: RefreshCw, tint: 'bg-rose-500/10 text-rose-400' },
];

const related = products.filter((p) => p.slug !== 'loyalty').slice(0, 3);
            ...
            {[
              {
                ...
                body: 'Guests sign up and redeem in seconds, so loyalty never slows down the line.',
              },
              {
                Icon: Shield,
                tint: 'bg-rose-500/10 text-rose-400',
                title: 'Reliable at scale',
                body: 'One location or hundreds, every guest profile and reward balance stays accurate.',
              },
              {
                Icon: Clock,
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See Loyalty in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
