...
const featureIcons = [
  ...
  { Icon: Smartphone, tint: 'bg-emerald-500/10 text-emerald-400' },
  { Icon: CreditCard, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: Layers, tint: 'bg-rose-500/10 text-rose-400' },
];

const hardwareIcons = [
  { Icon: Cpu, tint: 'bg-sky-500/10 text-sky-400' },
  { Icon: Wifi, tint: 'bg-emerald-500/10 text-emerald-400' },
  { Icon: Layers, tint: 'bg-purple-500/10 text-purple-400' },
];

const relatedIcons = [
  { Icon: Monitor, tint: 'bg-sky-500/10 text-sky-400' },
  { Icon: ChefHat, tint: 'bg-amber-500/10 text-amber-400' },
  { Icon: Smartphone, tint: 'bg-violet-500/10 text-violet-400' },
];
...
export default function HardwarePageClient() {
  return (
    <div className="min-h-screen bg-black text-white font-montserrat selection:bg-sky-500/30">
      {/* Hero */}
      <section className="relative pt-[128px] md:pt-[176px] pb-16 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-sky-500/20 via-sky-600/10 to-transparent pointer-events-none" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-sky-500/10 rounded-full blur-[150px] pointer-events-none opacity-50" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="min-w-0">
              <motion.div
                ...
                className="w-16 h-16 md:w-20 md:h-20 rounded-3xl bg-sky-500/10 border border-sky-500/20 flex items-center justify-center mb-8 text-sky-400"
              >
                <Monitor size={36} />
              </motion.div>
              ...
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-xs font-semibold uppercase tracking-[0.24em] text-sky-400 mb-4"
              >
                {hero.eyebrow}
              </motion.p>
            ...
            <motion.div
              ...
              className="min-w-0 rounded-[2rem] md:rounded-[2.5rem] border border-sky-500/20 bg-white/5 backdrop-blur-xl p-8 md:p-10"
            >
              ...
              <div className="space-y-5 md:space-y-6">
                {keyFeatures.map((feature, index) => (
                  ...
                  >
                    <div className="w-8 h-8 shrink-0 rounded-full bg-sky-500/10 text-sky-400 flex items-center justify-center mt-0.5">
                      <Check size={16} />
                    </div>
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See eatOS hardware in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
