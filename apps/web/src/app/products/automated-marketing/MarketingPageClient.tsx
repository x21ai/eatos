...
const featureIcons = [
  { Icon: UserRound, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: Target, tint: 'bg-pink-500/10 text-pink-400' },
  { Icon: Mail, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: BarChart3, tint: 'bg-pink-500/10 text-pink-400' },
];

const hardwareIcons = [
  { Icon: Zap, tint: 'bg-rose-500/10 text-rose-400' },
  { Icon: Mail, tint: 'bg-pink-500/10 text-pink-400' },
  { Icon: Lock, tint: 'bg-rose-500/10 text-rose-400' },
];

const related = products.filter((p) => p.slug !== 'automated-marketing').slice(0, 3);
      ...
      <section className="relative pt-32 md:pt-44 pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="site-container relative z-10">
          ...
          >
            ...
            <span className="text-white">Automated Marketing</span>
          </motion.div>
            ...
            {[
              {
                ...
                body: 'Campaigns launch in minutes, not days, so you can act on a slow Tuesday before Friday service.',
              },
              {
                Icon: Shield,
                tint: 'bg-rose-500/10 text-rose-400',
                title: 'Reliable at scale',
                body: 'One location or fifty, every guest message sends on time, every time, with the same brand voice.',
              },
              {
                Icon: Clock,
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See Automated Marketing in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
