...
const relatedIcons = [
  ...
  { Icon: Smartphone, tint: 'bg-indigo-500/10 text-indigo-400' },
];

const featureIcons = [
  { Icon: Store, tint: 'bg-violet-500/10 text-violet-400' },
  { Icon: Settings, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: FileText, tint: 'bg-violet-500/10 text-violet-400' },
  { Icon: CreditCard, tint: 'bg-purple-500/10 text-purple-400' },
];

const hardwareIcons = [
  { Icon: RefreshCw, tint: 'bg-violet-500/10 text-violet-400' },
  { Icon: Smartphone, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: Shield, tint: 'bg-violet-500/10 text-violet-400' },
];

const related = products.filter((p) => p.slug !== 'tableside-order-and-pay').slice(0, 3);
...
export default function TablesidePageClient() {
  return (
      ...
      <section className="relative pt-32 md:pt-44 pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="site-container relative z-10">
          ...
          >
            ...
            <span className="text-white">Tableside Order & Pay</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="min-w-0">
              ...
              >
                ...
                <BrochureButton brochureId="tableside-order-and-pay" />
              </motion.div>
            </div>
            ...
            {[
              {
                ...
                body: 'Guests order and pay without waiting. Orders route to the kitchen the moment they are submitted.',
              },
              {
                Icon: Shield,
                tint: 'bg-purple-500/10 text-purple-400',
                title: 'Reliable at scale',
                body: 'One QR code or a thousand. Menus, checks, and payments stay in sync across every location.',
              },
              {
                Icon: Clock,
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See Tableside Order & Pay in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
