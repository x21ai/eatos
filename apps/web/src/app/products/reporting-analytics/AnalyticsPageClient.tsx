...
const related = products.filter((p) => p.slug !== 'reporting-analytics').slice(0, 3);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="min-w-0">
              ...
              >
                ...
                <BrochureButton brochureId="reporting-and-analytics" />
              </motion.div>
            </div>
            ...
            {[
              {
                ...
                body: 'Numbers land the moment a check closes, so you act on today rather than last week.',
              },
              {
                Icon: Shield,
                tint: 'bg-sky-500/10 text-sky-400',
                title: 'Reliable at scale',
                body: 'One location or fifty, every store reports on the same definitions and the same clock.',
              },
              {
                Icon: Clock,
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See Analytics and Reporting in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
