...
const featureIcons = [
  { Icon: Wallet, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: RefreshCw, tint: 'bg-emerald-500/10 text-emerald-400' },
  { Icon: CreditCard, tint: 'bg-sky-500/10 text-sky-400' },
  { Icon: Layers, tint: 'bg-amber-500/10 text-amber-400' },
  { Icon: LayoutGrid, tint: 'bg-indigo-500/10 text-indigo-400' },
  { Icon: Flame, tint: 'bg-rose-500/10 text-rose-400' },
];

const hardwareIcons = [
  { Icon: Smartphone, tint: 'bg-purple-500/10 text-purple-400' },
  { Icon: BatteryCharging, tint: 'bg-emerald-500/10 text-emerald-400' },
  { Icon: ScanLine, tint: 'bg-sky-500/10 text-sky-400' },
];

const related = products.filter((p) => p.slug !== 'point-of-purchase').slice(0, 3);
...
export default function PopPageClient() {
  return (
    <div className="min-h-screen bg-black text-white font-montserrat selection:bg-purple-500/30">
      ...
      <section className="relative pt-32 md:pt-44 pb-16 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-500/20 via-purple-600/10 to-transparent pointer-events-none" />
        ...
        <div className="site-container relative z-10">
          ...
          >
            ...
            <span className="text-white">Point of Purchase</span>
          </motion.div>
            ...
            {[
              {
                ...
                body: 'Orders and payments happen at the table, so checks close faster and tables turn sooner.',
              },
              {
                Icon: Shield,
