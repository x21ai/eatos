        ...
        <div className="site-container">
          <motion.div {...rise} className="text-center mb-14 md:mb-20">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
              Built for real restaurant operations. Designed to keep stock accurate and costs under control.
            </p>
          </motion.div>
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10">
                See Inventory Management in action. Book a demo and we will show you how it fits
                your operation.
              </p>
