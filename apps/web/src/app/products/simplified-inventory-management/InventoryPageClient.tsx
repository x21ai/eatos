...
const featureIcons = [
  { Icon: BarChart3, tint: 'bg-amber-500/10 text-amber-400' },
  { Icon: Bell, tint: 'bg-orange-500/10 text-orange-400' },
  { Icon: Truck, tint: 'bg-amber-500/10 text-amber-400' },
  { Icon: ChefHat, tint: 'bg-orange-500/10 text-orange-400' },
];

const hardwareIcons = [
  { Icon: BarChart3, tint: 'bg-amber-500/10 text-amber-400' },
  { Icon: Link, tint: 'bg-orange-500/10 text-orange-400' },
  { Icon: Smartphone, tint: 'bg-amber-500/10 text-amber-400' },
];

const related = products.filter((p) => p.slug !== 'simplified-inventory-management').slice(0, 3);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="min-w-0">
              ...
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-xs font-semibold uppercase tracking-[0.24em] text-amber-400 mb-4"
              >
                {hero.eyebrow}
              </motion.p>
              ...
              >
                {hero.title} <span className="text-amber-400">{hero.titleAccent}</span>
              </motion.h1>
            ...
            <motion.div
              ...
              className="min-w-0 rounded-[2rem] md:rounded-[2.5rem] border border-amber-500/20 bg-white/5 backdrop-blur-xl p-8 md:p-10"
            >
        ...
        <div className="site-container">
          ...
          >
            <video
              ...
              playsInline
              preload="metadata"
              aria-label="InventoryOS demo animation"
            >
              ...
              <div className={`min-w-0 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                ...
                <div className="flex flex-wrap gap-4">
                  {feature.metrics.map((metric) => (
                    ...
                    >
                      <div className="text-2xl font-bold tracking-tighter text-amber-400">
                        {metric.value}
                      </div>
            ...
            {[
              {
                ...
                body: 'Count, adjust, and reorder in seconds. Inventory updates sync to every device in real time.',
              },
              {
                Icon: Shield,
                tint: 'bg-orange-500/10 text-orange-400',
                title: 'Reliable at scale',
                body: 'One location or one hundred, stock levels, recipes, and vendor records stay consistent everywhere.',
              },
              {
                Icon: Clock,
          ...
          <motion.div {...rise} className="relative rounded-[2.5rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-10">
                See Inventory Management in action. Book a demo and we will show you exactly how it fits your operation from day one.
              </p>
