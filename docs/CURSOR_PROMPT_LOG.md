...
- **Outcome:** Implemented in `5e29282e` with Worker build/review follow-ups through `f2b65278`; draft PR opened from `cursor/harden-worker-site-a376`. Verification in progress.
