...
- **Outcome:** Redirect pairs added in `73832cec`; PR on `cursor/seo-preserve-wix-redirects-dee2`. Sitemap.ts gap (~229 200s missing from staging sitemap) left out of scope.
