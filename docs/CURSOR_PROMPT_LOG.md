...
- **Outcome:** Implemented in `5e29282e` with Worker build follow-ups through `32fb1b93`; draft PR opened from `cursor/harden-worker-site-a376`. Verification in progress.
